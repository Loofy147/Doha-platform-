...
export default function AdminError({
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[calc(100vh-100px)] bg-muted/40 p-6 text-center">
      ...
      <h2 className="text-2xl font-semibold text-primary mb-3">خطأ في قسم الإدارة</h2>
      <p className="text-muted-foreground mb-6 max-w-md">
        حدث خطأ غير متوقع أثناء عرض هذا الجزء من لوحة التحكم.
      </p>
      ...
      <div className="flex gap-4">
        ...
        <Button asChild>
            <Link href="/admin">العودة للوحة تحكم المسؤول</Link>
        </Button>
      </div>
    </div>
  );
