...
const storeManagementNavItems = [
    ...
    { href: '/dashboard/store-template', icon: Palette, label: 'قالب وتصميم المتجر'}, // Changed icon to Palette
];
...
export function SellerDashboardSidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 right-0 z-40 hidden w-14 flex-col border-l bg-sidebar sm:flex"> 
      <TooltipProvider>
        ...
        <nav className="mt-auto flex flex-col items-center gap-4 px-2 sm:py-5">
          <Tooltip>
            ...
            <TooltipContent side="left">إعدادات المتجر العامة</TooltipContent> 
          </Tooltip>
        </nav>
      </TooltipProvider>
    </aside>
